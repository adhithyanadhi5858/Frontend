...
//         <button className="bg-indigo-600 text-white px-6 py-2 rounded-full text-lg hover:bg-indigo-700 transition-all duration-300">
//           Edit Profile
//         </button>
//       </div>
...
//                 </div>
//                 <button className="bg-indigo-600 text-white px-4 py-2 rounded-full text-sm hover:bg-indigo-700 transition-all duration-300">
//                   View Details
//                 </button>
//               </div>
//             ))
